...
hi Search               cterm=none ctermbg=2        ctermfg=234     gui=none        guibg=#2EB5C1   guifg=#F7F7F7
hi IncSearch            cterm=none ctermbg=221      ctermfg=234     gui=none        guibg=#F6DC69   guifg=#8F8F8F
...
hi PmenuThumb           cterm=none ctermbg=15       ctermfg=245     gui=none        guibg=#F7F7F7   guifg=#8F8F8F
hi SpellBad             cterm=none ctermbg=1        ctermfg=234     gui=none                        guifg=#F7F7F7
hi SpellCap             cterm=none ctermbg=4        ctermfg=234     gui=none                        guifg=#F7F7F7
...
hi DiffDelete           cterm=bold ctermbg=1        ctermfg=234
...
hi Underlined           cterm=none ctermbg=none ctermfg=69          gui=underline   guibg=#272727
